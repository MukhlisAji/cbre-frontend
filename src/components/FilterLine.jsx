...
const FilterLine = ({ onClickAction }) => {
  return (
    <div style={{ position: "absolute", bottom: "120px", left: "20px", backgroundColor: "#fff", padding: "10px", color: "white", width: "max-content", height: "100px", zIndex: 99999, borderRadius: '5px' }}>
