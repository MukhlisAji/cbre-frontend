...
import { SPACEDATADUMMY } from '../../../components/components/lib/const/DataEntryDummy';
import CustomTable from '../../components/shared/CustomTable';



export default function SpaceSubmitError() {
        ...
        <div className="flex-1 overflow-y-auto flex flex-col px-5 py-5 h-screen p-4 bg-white">
            ...
            <div className="bg-white shadow-lg py-3 px-3 rounded rounded-md">
                ...
                <div className="flex justify-end">
                    <button
                        onClick={() => handleSubmit('/data-entry-portal/mass-upload/space/submit')}
