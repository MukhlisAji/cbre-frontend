  ...
  useEffect(()=>{
    const customControl = {
      onAdd() {
        ...
        const svg =`
            <img id="2d" src="2d.svg" alt="2D" style="width:30px; height: 30px;  border-radius: 10%; margin-bottom:10px "/>
            <img id="mrt" src="mrt.svg" alt="MRT" style="width:30px; height: 30px;  border-radius: 10%;  margin-bottom:10px"/>
            <img id="house" src="house.svg" alt="House" style="width:30px; height: 30px;  border-radius: 10%;  margin-bottom:10px"/>
            `
