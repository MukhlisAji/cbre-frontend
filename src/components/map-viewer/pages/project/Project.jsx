    ...
    projects: [
        {
            id: 1,
            name: "Project Alpha",
            description: "A project focused on developing alpha features.",
            enabled: false,
        },
        {
            id: 2,
            name: "Project Beta",
            description: "A project focused on developing beta features.",
            enabled: true,
        },
    ],
    buildings: [
...
export default function Project() {
    ...
    return (
        <div className="relative">
            <div
                className={`fixed w-1/5 inset-y-0 right-0 z-20 flex flex-col transition-transform duration-300 ease-in-out bg-neutral-100 shadow-lg ${isOpen ? 'transform translate-y-12' : 'transform translate-y-full pointer-events-none'}`}
            >
                <div className="bg-neutral-100 h-full flex flex-col">
                    <div className='flex flex-col h-3/6 border-b'>
                        <div className='flex items-center justify-center bg-neutral-200'>
                            <h2 className="text-sm py-3 w-full text-center items-center font-semibold text-neutral-700">My Project List</h2>
                        </div>
