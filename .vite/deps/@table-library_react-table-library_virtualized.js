...
} from "./chunk-SNGNILI6.js";
import {
  i,
  o
} from "./chunk-OQOKVYXD.js";
import {
  e,
  e2,
  n
...
// node_modules/@table-library/react-table-library/virtualized.js
...
var a = function(a2, r2, t) {
  var e3 = 0;
  return a2 && ("number" == typeof a2 && (e3 = a2), "function" == typeof a2 && (e3 = a2(r2, t))), e3;
};
...
function m(e3) {
  for (var r2 = 1; r2 < arguments.length; r2++) {
    var o3 = null != arguments[r2] ? arguments[r2] : {};
    r2 % 2 ? p(Object(o3), true).forEach(function(r3) {
      e2(e3, r3, o3[r3]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e3, Object.getOwnPropertyDescriptors(o3)) : p(Object(o3)).forEach(function(r3) {
      Object.defineProperty(e3, r3, Object.getOwnPropertyDescriptor(o3, r3));
    });
  }
  return e3;
}
var u = function(t) {
  var p2 = t.tableList, u2 = t.rowHeight, b = t.header, y = t.body, O = t.tableOptions, v = t.rowOptions;
  return jsx(o2.Fragment, null, (null == O ? void 0 : O.renderBeforeTable) && O.renderBeforeTable(), jsx(index_esm_default, null, function(t2) {
    var i2 = t2.width, O2 = t2.height;
    return jsx(VariableSizeList, { height: O2, width: i2, itemCount: p2.length, itemSize: function(e3) {
      return a(u2, p2[e3], e3);
    }, innerElementType: o2.forwardRef(function(t3, o3) {
      var n2 = t3.children, i3 = e(t3, d);
      return jsx("div", n({ ref: o3 }, i3), jsx("div", { style: m(m({}, r), {}, { position: "sticky", insetBlockStart: 0, zIndex: 3 }) }, jsx(i, null, b())), jsx(o, null, n2));
    }), itemData: { items: p2 } }, function(e3) {
      var r2 = e3.index, t3 = e3.style, o3 = e3.data;
      return jsx("div", { style: m(m(m({}, t3), r), {}, { top: +(t3.top || 0) + a(u2, o3.items[r2], r2) }) }, (null == v ? void 0 : v.renderBeforeRow) && v.renderBeforeRow(o3.items[r2], r2), y(o3.items[r2], r2), (null == v ? void 0 : v.renderAfterRow) && v.renderAfterRow(o3.items[r2], r2));
    });
  }), (null == O ? void 0 : O.renderAfterTable) && O.renderAfterTable());
};
export {
  u as Virtualized,
  a as getRowHeight
};
//# sourceMappingURL=@table-library_react-table-library_virtualized.js.map
